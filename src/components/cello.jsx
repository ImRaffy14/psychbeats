...
import celloImg from '../assets/Instruments/Cello.png'
    ...
    return (
        <div className="min-h-screen w-full bg-bg bg-no-repeat bg-cover flex items-center justify-center p-4">
          <div className="max-w-md w-full flex flex-col items-center space-y-4">
            <img src={celloImg} alt="Handpan Instrument" className="h-auto mb-5" />
    
            <ReactPlayer
              url="https://res.cloudinary.com/dpyhkumle/video/upload/v1730524010/Cello_g1wdmw.mp3"
              playing
              controls
              volume={1}
              width="100%"
