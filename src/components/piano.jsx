...
import pianoImg from '../assets/Instruments/Piano.png'
    ...
    return (
        <div className="min-h-screen w-full bg-bg bg-no-repeat bg-cover flex items-center justify-center p-4">
          <div className="max-w-md w-full flex flex-col items-center space-y-4">
            <img src={pianoImg} alt="Handpan Instrument" className="h-auto mb-5" />
    
            <ReactPlayer
              url="https://res.cloudinary.com/dpyhkumle/video/upload/v1730524039/Piano_bmi1jx.mp3"
              playing
              controls
              volume={1}
              width="100%"
